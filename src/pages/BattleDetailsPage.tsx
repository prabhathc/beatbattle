...
import { Music2, Users, Clock, Trophy, AudioLines, Copy, Zap, Upload, Image as ImageIcon } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-gray-800 rounded-lg p-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-3xl font-bold text-white mb-4">Summer Beat Championship</h1>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-gray-800 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Submit Your Track</h2>
