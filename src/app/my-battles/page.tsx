    ...
    <div className="min-h-screen bg-gray-900 p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-white">My Lobbies</h1>
            <p className="text-gray-400 mt-1">Manage your battle and feedback sessions</p>
          </div>
          <button
            onClick={() => router.push('/create')}
            className="mt-4 sm:mt-0 px-4 py-2 bg-purple-500 hover:bg-purple-600 rounded-md text-white transition-colors flex items-center"
          >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                <div className="space-y-1">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    <span className={`px-3 py-1 rounded-full text-sm border ${getStatusColor(battle.status)}`}>
                      {battle.status.charAt(0).toUpperCase() + battle.status.slice(1)}
                    </span>
                    <span className="text-sm text-purple-400">
                      {battle.type === 'battle' ? 'Battle Lobby' : 'Feedback Lobby'}
                    </span>
                ...
                <div className="flex items-center space-x-4 mt-4 sm:mt-0">
                  <div className="text-right">
                    <div className="text-purple-400 font-semibold">{battle.prize}</div>
